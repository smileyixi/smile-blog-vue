<template>
  <div id="box">
    <button type="button" class="buttonCy">WARNNING</button>
    <div
      class="text"
      style="background-image: url(https://smilesl.top/uploads/404Bg.png)"
    >
      <div id="one">
        <span style="color: #ff0000; border-right: 3px solid #f7f7f7"
          >君子</span
        >
        不可欺之以方
      </div>
      ...
      <!--小标题 -打字机-->
      <div class="lTit" id="text">
        <span class="lTitWord"></span>
        <span class="lTitCursor">|</span>
      </div>
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://fonts.gstatic.com/s/librefranklin/v13/jizOREVItHgc8qDIbSTKq4XkRg8T88bjFuXOnduhLsWkD9DJTedX18mETQw.woff2) format('woff2');
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://fonts.gstatic.com/s/librefranklin/v13/jizOREVItHgc8qDIbSTKq4XkRg8T88bjFuXOnduhLsWkDtDJTedX18mETQw.woff2) format('woff2');
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://fonts.gstatic.com/s/librefranklin/v13/jizOREVItHgc8qDIbSTKq4XkRg8T88bjFuXOnduhLsWkANDJTedX18mE.woff2) format('woff2');
...
#box {
  ...
  font-size: 62.5%;
  /* background-image: linear-gradient(0deg, #f8e3eb, #fff4bd, #f49454, #ff6f27);
     */
  background-image: url(http://smilesl.com/background2.png);
  ...
  .text {
    ...
    cursor: default;
    border-radius: 20px;
    box-shadow: 10px 6px 10px #595959;
  }
  /* 大标题 */
  #one {
    padding: 3px;
  ...
  #one::before {
    ...
    width: 40%;
    height: 12px;
    background-color: #f80a1a;
    border-radius: 10px;
    box-shadow: 3px 5px 10px #ff0000;
    opacity: 0.8;
    transition: 0.3s;
  }
  #one::after {
    ...
    bottom: -15px;
    right: -15px;
    animation: titAfterMove 3s infinite;
  }
  #one::before {
    float: left;
    top: -15px;
    left: -15px;
    animation: titBeforeMove 3s infinite;
  }
  /* 标题装饰框动画 */
  @keyframes titBeforeMove {
    from {
  ...
  .buttonCy:hover::after {
    animation: 1s cyMove steps(2, end);
  }
  /* 故障动画 */
  @keyframes cyMove {
    from {
  ...
  .sun {
    ...
    height: 100px;
    border-radius: 50%;
    background-image: radial-gradient(circle at 50%, #ffffff 50%, #fa833f);
    box-shadow: 0px 0px 40px #f8e3eb, inset 0px 0px 100px #fdf0a3;
